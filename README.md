...
The example API specification used by this repository can be seen hosted at [https://campbellpryde.github.io/AuditData-API](https://campbellpryde.github.io/AuditData-API).
